...
public class UserUpdate {
  ...
  public UserUpdate middleName(String middleName) {
  ...
  public UserUpdate contactNumber(String contactNumber) {
  ...
  public UserUpdate department(String department) {
  ...
  public UserUpdate supervisor(String supervisor) {
  ...
  public UserUpdate driverType(String driverType) {
  ...
  public boolean equals(Object o) {
    ...
    UserUpdate userCreate = (UserUpdate) o;
